...
class ECRFField(BaseModel):
    ...
    data_type: str = Field(..., description="Data type from eCRF (e.g., '$25', '1', 'dd MMM yyyy')")
...
class ECRFExtractionResult(BaseModel):
    ...
    forms: list[ECRFForm] = Field(default_factory=list, description="All extracted eCRF forms")
