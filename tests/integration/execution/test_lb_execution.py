...
def lb_spec() -> DomainMappingSpec:
    ...
    mappings = [
        ...
        _mapping(var="DOMAIN", pattern=MappingPattern.ASSIGN, label="Domain Abbreviation", assigned="LB", order=2),
        ...
        _mapping(var="LBSEQ", pattern=MappingPattern.DERIVATION, label="Sequence Number", derivation="generate_seq", order=4),
        _mapping(var="LBTESTCD", pattern=MappingPattern.DIRECT, label="Lab Test or Examination Short Name", source="LBTESTCD", order=5),
        _mapping(var="LBTEST", pattern=MappingPattern.DIRECT, label="Lab Test or Examination Name", source="LBTEST", order=6),
        _mapping(var="LBCAT", pattern=MappingPattern.DIRECT, label="Category for Lab Test", source="LBCAT", order=7, core=CoreDesignation.EXP),
        _mapping(var="LBORRES", pattern=MappingPattern.DIRECT, label="Result or Finding in Original Units", source="LBORRES", order=8, core=CoreDesignation.EXP),
        _mapping(var="LBORRESU", pattern=MappingPattern.DIRECT, label="Original Units", source="LBORRESU", order=9, core=CoreDesignation.EXP),
        _mapping(var="LBSTRESC", pattern=MappingPattern.DIRECT, label="Character Result/Finding in Std Format", source="LBSTRESC", order=10, core=CoreDesignation.EXP),
        _mapping(var="LBSTRESN", pattern=MappingPattern.DIRECT, label="Numeric Result/Finding in Std Units", source="LBSTRESN", order=11, core=CoreDesignation.EXP),
        _mapping(var="LBSTRESU", pattern=MappingPattern.DIRECT, label="Standard Units", source="LBSTRESU", order=12, core=CoreDesignation.EXP),
        _mapping(var="LBSTNRLO", pattern=MappingPattern.DIRECT, label="Reference Range Lower Limit-Std Units", source="LBSTNRLO", order=13, core=CoreDesignation.EXP),
        _mapping(var="LBSTNRHI", pattern=MappingPattern.DIRECT, label="Reference Range Upper Limit-Std Units", source="LBSTNRHI", order=14, core=CoreDesignation.EXP),
        _mapping(var="LBNRIND", pattern=MappingPattern.DIRECT, label="Reference Range Indicator", source="LBNRIND", order=15, core=CoreDesignation.EXP),
        _mapping(var="LBSPEC", pattern=MappingPattern.DIRECT, label="Specimen Type", source="LBSPEC", order=16, core=CoreDesignation.EXP),
        _mapping(var="LBMETHOD", pattern=MappingPattern.DIRECT, label="Method of Test or Examination", source="LBMETHOD", order=17, core=CoreDesignation.PERM),
        _mapping(var="LBBLFL", pattern=MappingPattern.DIRECT, label="Baseline Flag", source="LBBLFL", order=18, core=CoreDesignation.EXP),
        _mapping(var="LBFAST", pattern=MappingPattern.DIRECT, label="Fasting Status", source="LBFAST", order=19, core=CoreDesignation.PERM),
        _mapping(var="LBDTC", pattern=MappingPattern.DIRECT, label="Date/Time of Specimen Collection", source="LBDTC", order=20),
        _mapping(var="LBDTF", pattern=MappingPattern.DIRECT, label="Date Imputation Flag", source="LBDTF", order=21, core=CoreDesignation.PERM),
    ]
...
def raw_lab_results() -> pd.DataFrame:
    ...
    return pd.DataFrame({
        ...
        "LBTEST": [
            "Alanine Aminotransferase", "White Blood Cell", "Hemoglobin",
            "Alanine Aminotransferase", "Alanine Aminotransferase",
            "White Blood Cell", "Hemoglobin", "Alanine Aminotransferase",
            "White Blood Cell", "Hemoglobin",
        ],
        "LBCAT": ["CHEMISTRY", "HEMATOLOGY", "HEMATOLOGY", "CHEMISTRY", "CHEMISTRY",
                  "HEMATOLOGY", "HEMATOLOGY", "CHEMISTRY", "HEMATOLOGY", "HEMATOLOGY"],
        "LBORRES": ["25", "5.2", "14.1", "30", "22", "6.0", "13.5", "28", "4.8", "15.0"],
        "LBORRESU": ["U/L", "10^3/uL", "g/dL", "U/L", "U/L", "10^3/uL", "g/dL", "U/L", "10^3/uL", "g/dL"],
        "LBSTRESC": ["25", "5.2", "14.1", "30", "22", "6.0", "13.5", "28", "4.8", "15.0"],
        "LBSTRESN": [25.0, 5.2, 14.1, 30.0, 22.0, 6.0, 13.5, 28.0, 4.8, 15.0],
        "LBSTRESU": ["U/L", "10^9/L", "g/L", "U/L", "U/L", "10^9/L", "g/L", "U/L", "10^9/L", "g/L"],
        "LBSTNRLO": [7.0, 4.0, 12.0, 7.0, 7.0, 4.0, 12.0, 7.0, 4.0, 12.0],
        "LBSTNRHI": [56.0, 11.0, 18.0, 56.0, 56.0, 11.0, 18.0, 56.0, 11.0, 18.0],
        "LBNRIND": ["NORMAL", "NORMAL", "NORMAL", "NORMAL", "NORMAL", "NORMAL", "LOW", "NORMAL", "NORMAL", "NORMAL"],
        "LBSPEC": ["BLOOD", "BLOOD", "BLOOD", "BLOOD", "BLOOD", "BLOOD", "BLOOD", "BLOOD", "BLOOD", "BLOOD"],
        "LBMETHOD": ["Photometry", "Flow Cytometry", "Photometry", "Photometry", "Photometry",
                     "Flow Cytometry", "Photometry", "Photometry", "Flow Cytometry", "Photometry"],
        "LBBLFL": ["Y", "", "", "", "Y", "", "", "Y", "", ""],
        "LBFAST": ["Y", "Y", "Y", "Y", "Y", "Y", "Y", "Y", "Y", "Y"],
        "LBDTC": [
            "2022-01-15", "2022-01-15", "2022-01-15", "2022-02-15",
            "2022-01-20", "2022-01-20", "2022-01-20",
...
class TestLBExecution:
    ...
    def test_lb_seq_generation(
        ...
        for _, group in result.groupby("USUBJID"):
            ...
            assert seq_values == sorted(seq_values), f"LBSEQ not monotonic for {group['USUBJID'].iloc[0]}"
